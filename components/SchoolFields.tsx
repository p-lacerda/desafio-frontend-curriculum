  ...
  return (
    <div>
      ...
      <label htmlFor="schoolName">
        ...
        <input
          name="schoolName"
          {...register('schools.0.schoolName', { required: true })}
        />
      </label>
      <label htmlFor="initialMonth">
        ...
        <select
          name="initialMonth"
          {...register('schools.0.initialMonth', { required: true })}
        >
        ...
        <select
          name="initialYear"
          {...register('schools.0.initialYear', { required: true })}
        >
          <option>2021</option>
          <option>2020</option>
        </select>
      ...
      <label htmlFor="finishMonth">
        ...
        <select
          name="finishMonth"
          {...register('schools.0.finishMonth', { required: true })}
        >
          <option>Janeiro</option>
          <option>Fevereiro</option>
        </select>
        <select
          name="finishYear"
          {...register('schools.0.finishYear', { required: true })}
        >
          <option>2022</option>
          <option>2023</option>
        </select>
