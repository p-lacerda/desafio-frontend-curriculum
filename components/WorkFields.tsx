  ...
  return (
    <div>
      <label htmlFor="companyName">
        ...
        <input
          name="companyName"
          {...register('works.0.companyName', { required: true })}
        />
      </label>
      <label htmlFor="workName">
        ...
        <input
          name="workName"
          {...register('works.0.workName', { required: true })}
        />
      </label>
      <label htmlFor="initialMonth">
        ...
        <select
          name="initialMonth"
          {...register('works.0.initialMonth', { required: true })}
        >
        ...
        <select
          name="initialYear"
          {...register('works.0.initialYear', { required: true })}
        >
          <option>2021</option>
          <option>2020</option>
        </select>
      ...
      <label htmlFor="finishMonth">
        ...
        <select
          name="finishMonth"
          {...register('works.0.finishMonth', { required: true })}
        >
          <option>Janeiro</option>
          <option>Fevereiro</option>
        </select>
        <select
          name="finishYear"
          {...register('works.0.finishYear', { required: true })}
        >
          <option>2022</option>
          <option>2023</option>
        </select>
